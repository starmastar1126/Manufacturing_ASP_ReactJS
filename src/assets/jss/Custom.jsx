...
class Custom extends Component {
	...
	componentDidMount = () => {
		...
		// MENU
		// var FX=function(t,e){return e(".menu-button").click(function(){e(".mobile_primary").toggle({direction:"left"}),e(".menu-button").toggleClass("open"),e(".mainnav .pull--right").toggleClass("open")}),e(".mobile_primary .menu-item-has-children").append('<span className="sub-menu--button"></span>'),e(".sub-menu--button").each(function(){e(this).click(function(){e(this).toggleClass("open"),e(this).prev().slideToggle()})})}(FX||{},jQuery);
		...
		$(document).ready(function(){
			...
			$(".element").click(function () {
				$(".category").attr('class', "element");
				$(this).attr('class', "category");
			});

			$(".left-sidebar").mouseover(function () {
				$(".home-category-ads").toggleClass("left-popup");
				$(".home-ads").css("display", 'none');
			});
			$(".left-sidebar").mouseout(function () {
				$(".home-category-ads").toggleClass("left-popup");
				$(".home-ads").css("display", 'block');
			});
		});
