...
class Footer extends React.Component {
  render() {
    return (
        <div>
          <section className="footer inner_footer">
            <div className="container">
              <div className="row">
                <div className="col-sm-3">
                  <h3>Quick Links</h3>
                  <ul>
                    <li> <a href="#"><i className="fa fa-angle-right"></i>24/7 Support</a> </li>
                    <li> <a href="#"><i className="fa fa-angle-right"></i>Features</a> </li>
                    <li> <a href="#"><i className="fa fa-angle-right"></i>About Us</a> </li>
                    <li> <a href="#"><i className="fa fa-angle-right"></i>Individual Terms &amp; Conditions</a> </li>
                    <li> <a href="#"><i className="fa fa-angle-right"></i>Business Terms &amp; Conditions</a> </li>
          ...
          <section className="footer">
            <div className="container">
              <div className="row">
                ...
                <div className="col-md-6">
                  <ul>
                    <li><a href="https://www.facebook.com/LawyersEzyFind.co.za/" className="fb"><i className="fab fa-facebook-f"></i></a></li>
                    <li><a href="https://plus.google.com/111975390368301243237" className="gp"><i className="fab fa-google-plus-g"></i></a></li>
                    <li><a href="https://twitter.com/search?f=tweets&q=LawyersEzyFind.co.za" className="rs"><i className="fab fa-twitter"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
