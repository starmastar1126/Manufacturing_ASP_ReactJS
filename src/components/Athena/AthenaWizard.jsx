...
import wizardStyle from "assets/jss/material-dashboard-pro-react/components/athena/athenaWizardStyle.jsx";

class AthenaWizard extends React.Component {
  constructor(props) {
    super(props);
    var width;
      ...
      <div className={classes.wizardContainer} ref="wizard">
        <div className={classes.wizardHeader}>
          ...
          <div className={classes.wizardNavigation}>
                ...
                return (
                  ...
                  >
                    <a
                      ...
                      onClick={e => {
                        e.preventDefault();
                        this.selectButtonClick(key);
                      }}
                    >
                      <span style={{textAlign: "center", fontSize: "16px", fontWeight: "500"}}>{prop.stepName}</span>
                    </a>
                  </li>
                );
              })}
            ...
            >
              <span style={{textAlign: "center", fontSize: "16px", fontWeight: "500"}}>{steps[this.state.currentStep].stepName}</span>
            </div>
          </div>
...
export default withStyles(wizardStyle)(AthenaWizard);
